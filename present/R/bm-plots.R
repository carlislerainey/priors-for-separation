...
plot.posterior.density <- function(sims) {
  ...
  polygon(c(x, rev(x)), c(y, zeros), col = col2a, lty = 0)
...
load("~/Dropbox/projects/priors-for-separation/safe/cauchy1.RData"); m.gelman <- m.cauchy.mcmc
load("~/Dropbox/projects/priors-for-separation/safe/firth1.RData"); m.zorn <- m.firth.mcmc
load("~/Dropbox/projects/priors-for-separation/safe/m-me.RData"); m.inf <- m.me
load("~/Dropbox/projects/priors-for-separation/safe/m-skep.RData")
load("~/Dropbox/projects/priors-for-separation/safe/m-enth.RData")
...
# simulate quantities of interest
## load and clean data
d <- read.csv("~/Dropbox/projects/priors-for-separation/bm-replication/data/bm.csv")
...
# coefficient plot 
pdf("figs/bm-coef.pdf", height = 3.5, width = 6)
...
# density plot
pdf("figs/bm-posterior-density.pdf", height = 3.75, width = 8)
...
# risk-ratio plot 
pdf("figs/bm-rr.pdf", height = 3.5, width = 6)
par(mfrow = c(1,1), mar = c(4,1,1,1), oma = c(0,0,0,0))
...
labs <- rev(c("Informative Normal(0, 4.5) Prior",
  ...
  "Zorn's Default Jeffreys' Prior",
  "Gelman et al.'s Default Cauchy(0, 2.5) Prior"))
pdf("figs/bm-pr-hypothesis.pdf", height = 3.5, width = 6)
