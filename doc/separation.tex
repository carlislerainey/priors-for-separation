...
\item \emph{Allows plausible effects.} The prior distribution should assign realistic prior probabilities to estimates that are \textit{a priori} plausible. 
\item \emph{Rules out implausible effects.} The prior distribution should assign essentially no prior probability to estimates that are \textit{a priori} implausible.
\end{enumerate}
